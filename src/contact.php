...
$fromEmail = 'noreply@unstuffeddesign.com';
$fromName = 'No Reply Email';

// an email address that will receive the email with the output of the form
$sendToEmail = 'noreply@unstuffeddesign.com';
...
try {
    ...
    $emailTextHtml .= "<h3>New message from unstuffed design:</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>unstuffed design, LLC</p>";
